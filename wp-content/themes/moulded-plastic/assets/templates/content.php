	...
	<div class="row align-center">
		...
		<?php
			the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'moulded-plastic' ), array( 'span' => array( 'class' => array() ) ) ),
